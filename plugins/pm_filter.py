...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @Star_x_network ♥️')
            else:
                await query.message.edit_text(
                    "I'm not connected to any groups!\nCheck /connections or connect to any groups",
                    quote=True
                )
                return await query.answer('♥️ Thank You @Star_x_network ♥️')
    ...
    if query.data.startswith("file"):
        ...
        await query.answer('♥️ Thank You @Star_x_network ♥️')
...
async def advantage_spell_chok(msg):
    ...
    await msg.reply("ʜᴇʏ sᴏɴᴀ! ᴍᴜᴊʜᴇ ɪs ɴᴀᴀᴍ sᴇ ᴋᴏɪ ᴍᴏᴠɪᴇ ɴʜɪ ᴍɪʟɪ, ᴍᴜᴊʜᴇ ʟɢᴛᴀ ʜᴀɪ ᴋɪ ᴀᴀᴘɴᴇ sᴘᴇʟʟɪɴɢ ɢᴀʟᴀᴛ ʟɪᴋʜ ᴅɪɪ ʜ 🤷‍♀️!\n ᴘʟᴇᴀsᴇ ᴄʜᴇᴄᴋ ʏᴏᴜʀ sᴘᴇʟʟɪɴɢ ᴏɴᴄᴇ ᴀɢᴀɪɴ 🤦‍♀️... ᴏʀ \n ᴅɪsᴄᴜss ʏᴏᴜʀ ᴘʀᴏʙʟᴇᴍ ᴡɪᴛʜ ᴏᴜʀ ᴀᴅᴍɪɴ ʜᴇʀᴇ 👉 @Best_FriendsFor_Ever ",
                    reply_markup=InlineKeyboardMarkup(btn))
